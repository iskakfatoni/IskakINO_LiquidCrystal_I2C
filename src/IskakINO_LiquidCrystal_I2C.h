...
public:
    ...
    /* Address control */
    // FIX #2: setAddress() sekarang bisa dipanggil kapan saja.
    // Kalau dipanggil setelah begin() sudah jalan, LCD otomatis
    // di-reinit dengan alamat baru (tidak lagi "terkunci").
